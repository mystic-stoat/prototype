...
const CTA = () => <section className="py-24 md:py-32">
    <div className="container mx-auto px-6">
      <ScrollReveal>
        <div className="bg-primary rounded-3xl p-12 md:p-20 text-center">
          ...
          <Link to="/signup">
            <Button variant="hero-outline" size="xl" className="border-primary-foreground/60 text-primary-foreground hover:bg-primary-foreground hover:text-primary">
