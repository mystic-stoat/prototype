  ...
  <footer className="bg-foreground text-primary-foreground py-16">
    <div className="container mx-auto px-6">
      <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
        ...
        {[
          { title: "My Account", links: ["Sign in", "Register"] },
          { title: "Help", links: ["FAQs", "Customer support"] },
          { title: "Legal Stuff", links: ["Terms of use", "Privacy policy"] },
          { title: "About", links: ["About us", "Careers"] },
        ].map((col) => (
          <div key={col.title}>
